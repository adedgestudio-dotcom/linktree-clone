      ...
      {showNavbar && (
        <nav className="navbar bg-white w-[95vw] md:w-[90vw] fixed top-4 md:top-10 right-[2.5vw] md:right-[5vw] rounded-full p-3 md:p-4 flex flex-row justify-between items-center z-50">
          ...
          <div className="flex items-center gap-2 md:gap-4">
            {/* Nav Buttons - Conditional based on auth status */}
            {session ? (
              <>
                <Link href="/mylinks">
                ...
                <button
                  onClick={() => signOut()}
                  className="Signupfree bg-[#1e2330] text-white py-3 px-5 md:py-4 md:px-6 font-bold rounded-full cursor-pointer text-sm md:text-base whitespace-nowrap"
                >
                  Sign Out
                </button>
              </>
              ...
              <>
                <button
                  ...
                  className="login bg-[#eff0ec] rounded-lg py-3 px-5 md:py-4 md:px-6 font-bold cursor-pointer text-sm md:text-base whitespace-nowrap"
                >
                  Login
                </button>
                <button
